    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_q', models.CharField(error_messages={'blank': 'sfdfsfsd'}, max_length=100, verbose_name='Имя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question_text', models.CharField(error_messages={'invalid': 'sfdfsfsd'}, max_length=200)),
